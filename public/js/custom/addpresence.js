// Initialize appendGrid
    $('#presence').appendGrid({
        ...
        initRows: 1,
        columns: [
                { name: 'presence', display: 'Presence Type', type: 'select', ctrlCss: { width: '150px'} ,ctrlOptions: { 0: '--SELECT--', 1: 'Brand display on Event', 2: 'Emcee Shoutout', 3: 'Social Media Interaction', 4: 'Event booth', 5: 'Brand on Marketing Poster', 6: 'Brand on Flyer', 7: 'Others'} },
