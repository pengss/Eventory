// Initialize appendGrid
    $('#presence').appendGrid({
        ...
        columns: [
                ...
                { name: 'description', display: 'Description', type: 'textarea', ctrlAttr: { maxlength: 300, rows:5, 'data-toggle':'tooltip','data-original-title':'Let the sponsor know more detail about how you can help them promote their brand through this presence'}, ctrlCss: { width: '300px'} },
                { name: 'price', display: 'Cost', type: 'text', ctrlAttr: { maxlength: 6, placeholder:'$', 'data-toggle':'tooltip','data-original-title':'Type in offer price for presence, or "Inkind" for non-monetary presence' }, ctrlCss: { width: '80px'} },
                { name: 'slot', display: 'Quantity', type: 'number', ctrlAttr: { min:1 }, ctrlCss: { width: '70px'} },
