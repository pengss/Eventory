            ...
            if (target.length > 0) {
                ...
                if (settings.hideButtons.append && settings.hideButtons.removeLast
                    ...
                    if (!settings.hideButtons.append) {
						...
						.attr({ title: settings._i18n.append }).addClass('fa fa-plus-square', 'btn btn-default')
                        .click(function (evt) {
                    ...
                    if (!settings.hideButtons.removeLast) {
						...
						.attr({ title: settings._i18n.removeLast }).addClass('fa fa-minus', settings._buttonClasses.removeLast)
						.click(function (evt) {
