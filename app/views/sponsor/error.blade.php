        ...
        <div id="error-container">
            <div class="row text-center">
                <div class="col-md-8 col-md-offset-2">
                    <h1 class="text-light animation-fadeInQuick"><strong>You have already chose this presence before</strong></h1>
                    <h2 class="text-muted animation-fadeInQuickInv"><em>Please go back to your dashboard and look at another event</em></h2>
                </div>
